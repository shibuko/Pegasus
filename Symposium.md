...
* 論理シナリオを作るさいに観測シーンの動的ふるまいを軽視すると、事実に基づかない証拠を含み、この結果、安全性は証明されているが補強証拠が提示されていない。  

関連性には観測シーンの分割に関する課題があり、結果的に作られる論理シナリオが交通における観測シーンの動的ふるまいを単純化したものではなくなってしまう。シーンの単純化の観点から、論理シナリオから導かれるテスト条件は簡単なものになり、
